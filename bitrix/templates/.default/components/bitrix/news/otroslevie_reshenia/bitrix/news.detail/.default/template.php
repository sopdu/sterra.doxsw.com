...
<div class="twelve right article">
	<h1><?if(!empty($arResult['DISPLAY_PROPERTIES']['H1_TITLE']["VALUE"])):?><?=$arResult['DISPLAY_PROPERTIES']['H1_TITLE']["VALUE"]?><?else:?><?=$arResult["NAME"];?><?endif?></h1>
	<div class="news" style="overflow: hidden">		<div class="clearfix"></div>
