...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("dlitelnost","doc","site","slysha_neobhodimo","ssylka","chena","trener",""),
		...
		"LIST_PROPERTY_CODE" => array("dlitelnost","site",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "6",
		...
		"SEF_FOLDER" => "/support/education/courses/",
		"SEF_MODE" => "Y",
