...
$APPLICATION->SetTitle("Запрос на доступ к базам решающих правил С-Терра СОВ");
...
if(isset($_POST['submit'])):
	...
	$arEventFields = array(
		...
		CEvent::Send('request for BRP SOV', SITE_ID, $arEventFields);
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		"AREA_FILE_SHOW" => "file",
		"PATH" => "/include/static_page/send_brp_query.php",
		"EDIT_TEMPLATE" => ""
	),
true
);?>
