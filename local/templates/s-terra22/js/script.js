  ...
  (function () {
    ...
    function clearInputs() {
      var checkboxes = document.querySelectorAll('.modal input[type="checkbox"], #vacant-form input[type="checkbox"]');
      var clearInputs = document.querySelectorAll('.modal input, .modal textarea, #vacant-form input, #vacant-form textarea');
  ...
  (function () {
    ...
    function tab($element) {
      ...
      if (!params['tab'] || params['tab'] == 'tech' || params['tab'] == 'lead') var activeItem = items[0];
...
// Общие скрипты для всех страниц
  ...
  (function () {
    ...
    var setItems = function setItems(data, setMoreBtn, currentPage, pagesizeAttr, setControlText, $body) {
      ...
      data.items.forEach(function (item) {
        if (item["long"]) {
          html += "\n    <div class=\"our-partners__list__bottom__item our-partners__list__bottom__item__long js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><a class=\"our-partners__list__bottom__item__title\" href=\""+item.link+"\">".concat(item.title, "</a>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
        } else {
          if (item.disabled) {
            html += "\n    <div class=\"our-partners__list__bottom__item our-partners__list__bottom__item__long  js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><div class=\"our-partners__list__bottom__item__title disabled\">".concat(item.title, "</div>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
          } else {
            html += "\n    <div class=\"our-partners__list__bottom__item our-partners__list__bottom__item__long  js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><a class=\"our-partners__list__bottom__item__title\" href=\""+item.link+"\">".concat(item.title, "</a>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
          }
        }
  ...
  (function () {
    ...
    components.formvideo(formvideo, formvideo.getAttribute('data-page-size'), setItems); // const itemLength = 10
  ...
  (function () {
    ...
    if (vacantForm) {
      ...
      var validator = utils.validator(vacantForm, {
        ...
        agreement: {
          required: {
            message: 'Принятие согласия на обработку своих персональных данных обязательно при отклике на вакансию'
          }
        }
      }, {
        parent: '.form-field',
...
/*
  ...
  (function () {
    ...
    var itemLength = window.innerWidth > 1020 ? 24 : 12;
  ...
  var callback = function () {
    ...
    for (var i=0; i<scrollSelect.length; i++){
      scrollSelect[i].addEventListener('click', function () {
        if (!window.elemscroll) {
          setTimeout(function () {
            new slimScroll(document.querySelector('.select-items'), {
              'wrapperClass': 'scroll-wrapper',
              'scrollBarContainerClass': 'scrollBarContainer',
              'scrollBarClass': 'scroll'
            });
