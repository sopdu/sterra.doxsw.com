	...
	<div class="twelve documents-info">
		<table style="width:100%">			
							<?if($arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']):?>								
								<?if(count($arItems['DISPLAY_PROPERTIES']['FILE']['VALUE'])>1):?>								
					...
					<?/*
								...
								<?else:?>
									...
									<tr>
										<td style="width:80%">
											<?if($arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['DESCRIPTION']):?>
											<?=$arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['DESCRIPTION']?>
											<?else:?>
											<?=$arFiel['ORIGINAL_NAME']?>
											<?endif;?>
										</td>
										<td width="100">
											<i><?=getFileExt($arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['SRC']);?>, <?=HumanBytes($arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['FILE_SIZE'])?></i>
										</td>
										<td width="50">
											<a href="/include/save_file.php?filename=<?=$arItems['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['ID']?>"><div class="icons icon-download view"></div></a>				
										</td>
									</tr>
								<?endif;?>
							<?else:?>
