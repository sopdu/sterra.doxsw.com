  ...
  (function () {
    ...
    function vacant($element) {
      ...
      if (typeof ($controlMoreBtn) != 'undefined') {
      ...
      function setMoreBtn(fullLength, page, pageSize) {
        if (page * pageSize < fullLength) {
          if (typeof ($controlMoreBtn) != 'undefined') $controlMoreBtn.classList.add(states.active);

          if (fullLength - page * pageSize > pagesize) {
            if (typeof ($controlMoreBtn) != 'undefined') $controlMoreBtn.textContent = "\u0415\u0449\u0435 ".concat(pagesize);
          } else {
            if (typeof ($controlMoreBtn) != 'undefined') $controlMoreBtn.textContent = "\u0415\u0449\u0435 ".concat(fullLength - page * pageSize);
          }
        } else {
          if (typeof ($controlMoreBtn) != 'undefined') $controlMoreBtn.classList.remove(states.active);
        }
      }
    }
