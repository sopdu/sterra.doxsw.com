<h2>Как правильно выбрать VPN?</h2>
...
<ul class="accordeon">
 ...
 <i>«На углу двое юношей возились с каким-то механическим устройством. Один убежденно говорил: «Конструкторская мысль не может стоять на месте. Это закон развития общества. Мы изобретём его. Обязательно изобретём. Вопреки бюрократам вроде Чинушина и консерваторам вроде Твердолобова». Другой юноша нёс свое: «Я нашел, как применить здесь нестирающиеся шины из полиструктурного волокна с вырожденными аминными связями и неполными кислородными группами. Но я не знаю пока, как использовать регенерирующий реактор на субтепловых нейтронах. Миша, Мишок! Как быть с реактором?» Присмотревшись к устройству, я без труда узнал велосипед.»</i><br>
	...
	<div class="accord-content">
		...
		<table class="i40" style="width: 100%;">
		<tbody>
		<tr>
			<td class="i2" style="width: 30%; text-align: center;">
				 Продукт
			</td>
			<td class="i2" style="width: 50%; text-align: center;">
				 ФСБ России
			</td>
			<td class="i2" style="width: 20%; text-align: center;">
				 ФСТЭК России
			</td>
		</tr>
		<tr>
			...
			<td rowspan="6" class="i40" style="text-align: center;">
				 МЭ 3, НСД 3, ОУД 4+, НДВ 3, АС 1В, ГИС до 1кл вкл., ПДн 1-4 ур.
			</td>
		</tr>
		<tr>
			<td class="i40">
				 Модуль Cisco (MCM 950)
			</td>
			<td class="i40">
				 КС1, КС2, КС3, МЭ4
			</td>
		...
		<tr>
			...
			<td class="i40" style="text-align: center;">
				 —
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="i40">
				 Маршрутизатор ST2911R
			</td>
			<td class="i40">
				 Уровень защищенности от компьютерных атак C1
			</td>
			<td class="i40" style="text-align: center;">
				 НДВ4, МЭ3
			</td>
	...
	<div class="accord-content">
		...
		<p>
			 Единственный российский поставщик VPN, имеющий <a href="products/price/">полностью открытый прайс-лист</a> – это компания «С-Терра СиЭсПи». Первый год технической поддержки уже включен в стоимость продуктов. Средство централизованного обновления и мониторинга является полезным и удобным, но не обязательным для функционирования системы. Что касается средства выпуска ключевой информации, то заказчик может использовать любой УЦ, выпускающий ГОСТ-сертификаты, как существующий, так и технологический (Microsoft CA c Крипто-Про CSP), стоимость которого минимальна.
		</p>
		<p>
		...
		<p>
			 О технических преимуществах каждого варианта сказано выше. Здесь отметим снижение стоимости решения при использовании криптографии ST – до 20% для клиентского ПО. Открытые прайс-листы на продукты С-Терра как с криптографией ST, так и криптографией СР размещены <a href="products/price/">на сайте</a>.
		</p>
		<p>
...
<tr>
	...
	<td>
		 ФСТЭК РФ - МЭ 3, НСД 3, ОУД 4+, НДВ 3, АС 1В, ГИС до 1кл вкл., ПДн 1-4 ур., ФСБ РФ – СКЗИ КС1, КС2, КС3, МЭ4
	</td>
	<td style="text-align: center;">
		 Соответствие требованиям законодательства (ФЗ152, приказ ФСТЭК №17,21, стандарт Банка России и т.д.)
	</td>
</tr>
<tr>
	<td>
...
<tr>
	...
	<td>
		 От 10 Мбит/с до 7.5 Гб/c в зависимости от модели и типа трафика
	</td>
	<td style="text-align: center;">
...
<tr>
	...
	<td>
		 Разнообразие вариантов: cisco-like консоль, С-Терра КП, CSM, GUI
	</td>
	<td style="text-align: center;">
		 Привычные средства управление, снижение затрат на поддержку и обучение
	</td>
</tr>
<tr>
	<td>
...
<p>
 ...
 или по электронной почте: <span style="font-size: 10pt;"><a href="mailto:sales@s-terra.com">sales@s-terra.com</a></span>.
<p>
</p>
<p>
