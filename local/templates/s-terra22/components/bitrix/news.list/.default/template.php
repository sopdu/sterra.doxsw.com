...
<div class="pressnews-page__content <?=$arResult['ID'] == 36 ? 'no-img' : ''?>" data-iblock="<?=$arParams['IBLOCK_ID']?>" data-full-length="<?=$arResult['NAV_RESULT']->nSelectedCount?>" data-page-size="<?=$arResult['NAV_RESULT']->nSelectedCount->NavPageSize?>" data-action="/local/ajax/news.php" data-method="GET">
