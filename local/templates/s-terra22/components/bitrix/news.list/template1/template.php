...
<div class="pressnews-page__content" data-iblock="<?=$arParams['IBLOCK_ID']?>" data-full-length="<?=$arResult['NAV_RESULT']->nSelectedCount?>" data-page-size="<?=$arResult['NAV_RESULT']->nSelectedCount->NavPageSize?>" data-action="/local/ajax/news.php" data-method="GET">
