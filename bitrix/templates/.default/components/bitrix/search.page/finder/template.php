...
<div class="search-page">
	...
	<form action="" method="get">
		...
		<div class="new_twelve soft-blue doc-search">
			...
			<?else:?>
				<input class="search_input" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" />
			<?endif;?>
			<input class="blue right" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<div class="select">
				...
				<p class="search-text" ><?echo $arItem["BODY_FORMATED"]?></p>
			</div>	
				<?if(
