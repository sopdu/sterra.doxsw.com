...
(function () {
  ...
  var setItems = function setItems(data, setMoreBtn, currentPage, pagesizeAttr, setControlText, $body) {
    ...
    data.items.forEach(function (item) {
      if (item["long"]) {
        html += "\n    <div class=\"our-partners__list__bottom__item our-partners__list__bottom__item__long js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><a class=\"our-partners__list__bottom__item__title\" href=\"#\">".concat(item.title, "</a>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
      } else {
        if (item.disabled) {
          html += "\n    <div class=\"our-partners__list__bottom__item  js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><div class=\"our-partners__list__bottom__item__title\">".concat(item.title, "</div>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
        } else {
          html += "\n    <div class=\"our-partners__list__bottom__item  js-item\">\n                      <div class=\"our-partners__list__bottom__item_wrap\"><a class=\"our-partners__list__bottom__item__title\" href=\"#\">".concat(item.title, "</a>\n                        <div class=\"our-partners__list__bottom__item__city\">").concat(item.city, "</div>\n                        <div class=\"our-partners__list__bottom__item__area\">").concat(item.area, "</div>\n                      </div>\n                    </div>\n                    ");
        }
      }
