(() => {
    ...
    <div class="our-partners__list__bottom__item our-partners__list__bottom__item__long js-item">
                      <div class="our-partners__list__bottom__item_wrap"><a class="our-partners__list__bottom__item__title" href="#">${item.title}</a>
    ...
    <div class="our-partners__list__bottom__item  js-item">
                      <div class="our-partners__list__bottom__item_wrap"><div class="our-partners__list__bottom__item__title">${item.title}</div>
                        <div class="our-partners__list__bottom__item__city">${item.city}</div>
                        <div class="our-partners__list__bottom__item__area">${item.area}</div>
                      </div>
                    </div>
