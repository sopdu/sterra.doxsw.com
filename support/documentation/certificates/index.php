...
?><div class="support-documentation-page page-main">
	...
	<div class="container">
          <div class="support-documentation__title">Документация</div>
 ...
 <img src="/local/templates/s-terra22/images/support-main/main.png">
			...
			<div class="support-documentation__banner__text">
				...
				<a class="btn btn-accent" target="_blank" href="https://doc.s-terra.ru/">Перейти на портал</a>
			</div>
		</div>
        <ul class="support-documentation-page__filter" id="nav">
            <li class="support-documentation-page__filter__item"><a class="support-documentation-page__filter__button active" type="button" data-type="1" href="/support/documentation/certificates/#nav">Сертификаты на продукцию</a></li>
		 ...
		 <?
         $GLOBALS['t2Filter'] = Array('PROPERTY_file' != false);
         $APPLICATION->IncludeComponent(
             "bitrix:news.list",
             "template2",
             Array(
                 ...
                 "PROPERTY_CODE" => array("ACTIV_TO","ACTIV_FROM","CRIPTOGRAFY","TYPE","file",""),
                 "SET_BROWSER_TITLE" => "N",
                 "SET_LAST_MODIFIED" => "N",
